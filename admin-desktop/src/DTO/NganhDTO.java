...
public class NganhDTO {
    ...
    // Constructor đầy đủ
    public NganhDTO(int idnganh, String manganh, String tennganh, String n_tohopgoc,
                    int n_chitieu, BigDecimal n_diemsan, BigDecimal n_diemtrungtuyen,
                    String n_tuyenthang, String n_dgnl, String n_thpt, String n_vsat,
                    Integer sl_xtt, Integer sl_dgnl, Integer sl_vsat, Integer sl_thpt) {
