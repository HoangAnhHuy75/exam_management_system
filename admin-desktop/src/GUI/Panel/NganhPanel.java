    ...
    public void dataTable(ArrayList<NganhDTO> listNganh) {
        ...
        for (NganhDTO ng : listNganh) {
            model.addRow(new Object[]{
                ng.getManganh(), ng.getTennganh(), ng.getN_tohopgoc(), ng.getN_chitieu(), ng.getN_diemsan(), ng.getN_diemtrungtuyen(), ng.getN_tuyenthang(), ng.getN_dgnl(), ng.getN_thpt(), ng.getN_vsat(), ng.getSl_xtt(), ng.getSl_dgnl(), ng.getSl_thpt(), ng.getSl_vsat()
            });
        }
