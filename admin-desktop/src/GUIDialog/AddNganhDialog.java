...
public class AddNganhDialog extends javax.swing.JDialog {
    ...
    public void loadCbb(){
        ArrayList<String> tohopgocList = nganhBus.getListToHopGoc();
        for(String thg : tohopgocList){
            cbb_tohopgoc.addItem(thg);
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel9);
        jLabel9.setBounds(360, 160, 90, 16);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String manganh = jtf_manganh.getText();
        String tennganh = jtf_tennganh.getText();
        int chitieu = Integer.parseInt(jtf_chitieu.getText());
        BigDecimal diemsan = new BigDecimal(jtf_diemsan.getText());
        String tohopgoc = (String) cbb_tohopgoc.getSelectedItem();
        int slthpt = Integer.parseInt(jtf_thpt.getText());
        int slvsat = Integer.parseInt(jtf_vsat.getText());
        int sltt = Integer.parseInt(jtf_sltt.getText());
        int sldgnl = Integer.parseInt(jtf_dgnl.getText());
        NganhDTO nganhDto = new NganhDTO();
        nganhDto.setManganh(manganh);
        nganhDto.setTennganh(tennganh);
        nganhDto.setN_chitieu(chitieu);
        nganhDto.setN_diemsan(diemsan);
        nganhDto.setN_tohopgoc(tohopgoc);
        nganhDto.setSl_dgnl(sldgnl);
        nganhDto.setSl_thpt(slthpt);
        nganhDto.setSl_xtt(sltt);
        nganhDto.setSl_vsat(slvsat);
        nganhDto.setN_tuyenthang(jcheck_tuyenthang.isSelected() ? "Y" : "N");
        nganhDto.setN_dgnl(jcheck_dgnl.isSelected() ? "Y" : "N");
        nganhDto.setN_thpt(jcheck_thpt.isSelected() ? "Y" : "N");
        nganhDto.setN_vsat(jcheck_vsat.isSelected() ? "Y" : "N");
