 ...
 * @author HP
 */
public class EditDiemCongDialog extends javax.swing.JDialog {
    
    DiemCongPanel diemCongPanel;
    DiemCongBUS diemCongBus = new DiemCongBUS();
    Combobox_design cbb_design = new Combobox_design();
    DiemThiBUS diemthiB = new DiemThiBUS();
    NganhBUS ngB = new NganhBUS();
    private DiemCongDTO dcDTO;
    public EditDiemCongDialog(java.awt.Frame parent, boolean modal, DiemCongPanel diemCongPanel,DiemCongDTO dcDTO) {
        super(parent, modal);
        initComponents();
        this.diemCongPanel = diemCongPanel;
        this.setLocationRelativeTo(null);
        this.setTitle("Sửa điểm cộng");
        this.dcDTO = dcDTO;
        khoiTao();
    }
    public void khoiTao(){
    ...
    public void loadData() {
        ...
        field_utxt.setText(getText(dcDTO.getDiemUtxt()));
        field_diemtong.setText(getText(dcDTO.getDiemTong()));
        field_dckeys.setText(dcDTO.getDc_keys());
        textArea_ghichu.setText(dcDTO.getGhichu());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sửa điểm cộng tuyển sinh");
    ...
    private void btn_luuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_luuActionPerformed
        ...
        // sửa dữ liệu
        DiemCongDTO dc = dcDTO;
        dc.setIddiemcong(dcDTO.getIddiemcong());
        dc.setTs_cccd(Cccd);
        ...
        if(diemCongBus.update(dc) == 1) {
            JOptionPane.showMessageDialog(this, "Sửa điểm cộng thành công","Thông báo",JOptionPane.INFORMATION_MESSAGE);
            diemCongPanel.dataTable(diemCongBus.getList());
            this.dispose();
        } else {
