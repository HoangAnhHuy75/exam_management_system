...
private ArrayList<JCheckBox> roleCheckboxes =
     ...
     */
    public EditUser(java.awt.Frame parent, boolean modal, UserPanel userPanel,int userID) {
        super(parent, modal);
    initComponents();
   ...
   private void addPasswordField() {
    ...
    if (chk_showPassword.isSelected()) {
        jPasswordField1.setEchoChar((char) 0); // hiện mật khẩu
    } else {
        jPasswordField1.setEchoChar('*'); // ẩn lại
    }
}
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     if (isChanged()) {
        int choice = JOptionPane.showConfirmDialog(
                this,
                "Bạn đã thay đổi dữ liệu. Nếu thoát sẽ không được cập nhật!\nBạn có muốn tiếp tục?",
                "Xác nhận",
