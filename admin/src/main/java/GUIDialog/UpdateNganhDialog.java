 ...
 * @author kiman
 */
public class UpdateNganhDialog extends javax.swing.JDialog {
    NganhDTO nganhDto;
    ...
    /**
     * Creates new form UpdateNganhDialog
     */
    public UpdateNganhDialog(java.awt.Frame parent, boolean modal, NganhPanel nganhPanel, NganhDTO nganhDto) {
        super(parent, modal);
        initComponents();
        this.setTitle("Cập nhật ngành");
    ...
    public void setData() {
        ...
        // Combobox tổ hợp
        cbb_tohopgoc.setSelectedItem(nganhDto.getNToHopGoc());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cập nhật ngành tuyển sinh");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // ===== 7. LẤY MÃ TỔ HỢP =====
        String maTH = (String) cbb_tohopgoc.getSelectedItem();
        System.out.println("id cua nganh la "+nganhDto.getIdNganh());
        // ===== 8. TẠO DTO =====
